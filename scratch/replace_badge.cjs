...
const newSectionLines = [
  ...
  '                className="flex items-center justify-center gap-1.5 bg-[#1e406f] hover:bg-[#152e50] text-white font-bold px-4 py-2.5 rounded-xl transition-all shadow-md text-xs"',
  '              >',
