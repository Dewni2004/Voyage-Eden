        ...
        <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="flex-1 text-center md:text-left">
            <h2 className="text-white text-3xl md:text-5xl font-serif mb-4 md:mb-2 leading-tight">
              Reserve Your <span className="text-luxury">Journey</span>
            </h2>
            <p className="text-white/70 text-base md:text-lg font-light max-w-xl leading-relaxed">
              Flexible dates available. We tailor every detail to your pace, ensuring an unforgettable Sri Lankan escape.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end gap-6 w-full md:w-auto">
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-white/50 text-lg md:text-xl font-light">/ per guest</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <button className="group/btn relative w-full sm:w-auto bg-luxury hover:bg-luxury/90 text-white font-bold px-10 py-4 rounded-xl shadow-xl transition-all duration-300 transform hover:-translate-y-1 active:scale-95 text-base overflow-hidden whitespace-nowrap">
                <span className="relative z-10">Secure My Booking</span>
              </button>
              
              <button className="w-full sm:w-auto bg-white/5 hover:bg-white/10 text-white font-semibold px-10 py-4 rounded-xl border border-white/10 backdrop-blur-sm transition-all duration-300 text-base whitespace-nowrap">
                Download PDF
              </button>
            </div>
            
            <p className="text-white/30 text-xs font-light text-center md:text-right">
              *Price may vary based on customization and seasonal availability
            </p>
          </div>
        </div>
      </div>
