...
const CategoryPillsSection = () => {
  ...
  return (
    <div className="mt-20 pt-16 border-t border-gray-100">
      <div className="flex overflow-x-auto hide-scrollbar gap-4 md:gap-6 lg:gap-8 pb-12 px-6 md:px-4 max-w-[1400px] mx-auto md:justify-center">
        {categories.map((category, idx) => (
          <a 
            key={category.id}
            href={`/itineraires#${category.id}`}
            className="group flex flex-col items-center gap-4 shrink-0 mx-auto"
          >
            <div className="relative w-20 h-20 md:w-24 md:h-24 lg:w-[100px] lg:h-[100px] rounded-full flex items-center justify-center">
            ...
            <h4 className="text-gray-600 group-hover:text-primary font-sans text-[10px] md:text-xs font-bold tracking-[0.2em] text-center uppercase max-w-[120px] md:max-w-[140px] transition-colors duration-300">
