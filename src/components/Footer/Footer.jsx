        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 flex flex-col space-y-6">
            <img 
              ...
              className="h-16 md:h-20 w-auto object-contain brightness-0 invert self-start"
            />
            ...
            <div className="flex space-x-4">
              {[
                ...
                <a key={icon.name} href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center hover:bg-luxury transition-all duration-300">
                  <svg className="w-5 h-5 text-[#102a43]" fill="currentColor" viewBox="0 0 24 24">
                    <path d={icon.path} />
                  </svg>
                </a>
              ))}
