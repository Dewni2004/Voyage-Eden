...
export const staticItineraries = [
  ...
  { id: "static-4", title: "Romance à Ceylan", image: honeymoonCard, price: '1,850', description: 'Un voyage romantique inoubliable pour les jeunes mariés.', duration: '10 Jours', group: 'Couple', effort: 'Faible', category: 'honeymoon', days: [{ id: 1, location: 'Bentota', description: 'Séjour balnéaire de luxe.', image: honeymoonCard, coords: { x: 80, y: 320 }, highlights: 'Dinner on the beach, Spa, Sunset', accommodation: 'Cinnamon Bey', meals: 'Half Board' }] },
  { id: "static-5", title: "Lune de miel exotique", image: tour1, price: '2,100', description: 'Détente et luxe dans les plus beaux cadres de l\'île.', duration: '12 Jours', group: 'Couple', effort: 'Faible', category: 'honeymoon', days: [{ id: 1, location: 'Tangalle', description: 'Plages sauvages et romantisme.', image: tour1, coords: { x: 120, y: 420 }, highlights: 'Private pool, Beach walks', accommodation: 'Anantara Peace Haven', meals: 'Full Board' }] },
