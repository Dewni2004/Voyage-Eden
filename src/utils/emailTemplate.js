...
const translations = {
  ...
  es: {
    ...
    keys: {
      ...
      standard: "Estándar", superior: "Superior", luxury: "Lujo", superLuxury: "Súper Lujo", driverEnglish: "Chofer en inglés",
  ...
  it: {
    ...
    keys: {
      ...
      standard: "Standard", superior: "Superiore", luxury: "Lusso", superLuxury: "Super Lusso", driverEnglish: "Autista parlante inglese",
