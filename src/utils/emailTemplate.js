...
const translations = {
  ...
  it: {
    ...
    keys: {
      ...
      standard: "Standard (circa 3 stelle)", superior: "Superior (circa 4/5 stelle)", luxury: "Hotel di lusso", superLuxury: "Super Lusso", driverEnglish: "Autista parlante inglese",
