...
const translations = {
  en: {
    ...
    keys: {
      ...
      numTravelers: "No. of Travelers", travelers_count: "No. of Travelers",
      ...
      room_distribution: "Room Distribution", room_count: "No. of Rooms", room_type: "Room Type", mealPlan: "Meal Plan", meal_plan: "Meal Plan",
  ...
  es: {
    ...
    keys: {
      ...
      numTravelers: "Nº de viajeros", travelers_count: "Nº de viajeros",
      ...
      room_distribution: "Distribución de habitaciones", room_count: "Nº de habitaciones", room_type: "Tipo de habitación", mealPlan: "Plan de comidas", meal_plan: "Plan de comidas",
  ...
  fr: {
    ...
    keys: {
      ...
      whoWith: "Avec qui voyagez-vous", whereAt: "Étape de planification", planeTickets: "Billets d'avion",
      numTravelers: "Nbre de voyageurs", travelers_count: "Nbre de voyageurs",
      ...
      room_distribution: "Répartition des chambres", room_count: "Nbre de chambres", room_type: "Type de chambre", mealPlan: "Plan de repas", meal_plan: "Plan de repas",
  ...
  de: {
    ...
    keys: {
      ...
      whoWith: "Mit wem reisen", whereAt: "Planungsphase", planeTickets: "Hat Flugtickets",
      numTravelers: "Anzahl der Reisenden", travelers_count: "Anzahl der Reisenden",
      ...
      room_distribution: "Zimmeraufteilung", room_count: "Anzahl der Zimmer", room_type: "Zimmertyp", mealPlan: "Verpflegungsplan", meal_plan: "Verpflegungsplan",
  ...
  it: {
    ...
    keys: {
      ...
      whoWith: "Con chi viaggi", whereAt: "Fase di pianificazione", planeTickets: "Ha i biglietti aerei",
      numTravelers: "N. di viaggiatori", travelers_count: "N. di viaggiatori",
      ...
      room_distribution: "Distribuzione camere", room_count: "N. di camere", room_type: "Tipo di camera", mealPlan: "Piano pasti", meal_plan: "Piano pasti",
