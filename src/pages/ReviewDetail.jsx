    ...
    <div className="bg-[#f8fbff] min-h-screen">
      ...
      <div className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-6 mt-20">
          <span className="bg-primary text-white text-xs font-bold px-6 py-2 rounded-full uppercase tracking-widest mb-6 inline-block shadow-lg">Traveler Story</span>
          <h1 className="text-4xl md:text-6xl font-bold font-serif mb-4">{review.name}'s</h1>
          <p className="text-xl md:text-2xl font-medium tracking-wide uppercase opacity-90">Sri Lanka Journey</p>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-16 relative">
          ...
          <div className="lg:w-2/3 bg-white p-8 md:p-16 rounded-[40px] shadow-xl border border-gray-100 -mt-32 relative z-20">
            ...
            <div className="pt-16 border-t border-gray-100">
              <h3 className="text-primary text-2xl font-bold mb-10">Memories from the trip</h3>
          ...
          <div className="lg:w-1/3 space-y-8">
            ...
            <div className="bg-white p-10 rounded-[40px] shadow-lg border border-gray-100">
              <h3 className="text-primary text-xl font-bold mb-8">About The Tour</h3>
            ...
            <div className="bg-gray-100 p-8 rounded-[40px] border border-gray-200">
              <h3 className="text-primary text-xl font-bold mb-6">Featured Guide</h3>
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h4 className="text-primary font-bold">{review.guide?.name || 'Hasindu'}</h4>
                  <div className="flex text-yellow-400 text-[10px]">{'★'.repeat(review.guide?.rating || 5)}</div>
                  <p className="text-gray-400 text-[10px] font-bold uppercase mt-1">Eden Travels Guide</p>
                </div>
              </div>
              <div className="bg-white p-6 rounded-3xl relative">
                ...
                <p className="text-gray-600 text-sm italic leading-relaxed pl-6">
                  "{review.guide?.quote || "It was a pleasure showing them the hidden gems of our beautiful island. A truly wonderful couple!"}"
                </p>
              </div>
            </div>
          </div>
