          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-10 md:p-12 rounded-[40px] shadow-xl border border-gray-100 flex flex-col items-center text-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
              ...
              <div className="space-y-6 text-gray-600 font-medium leading-relaxed text-sm md:text-base">
                <a href="mailto:srilankaedentravels@gmail.com" className="block text-primary hover:text-primary/80 transition-colors underline decoration-primary/50 underline-offset-4">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-primary font-bold">+94 77 147 0150 <span className="text-gray-500 font-normal">(WhatsApp)</span></p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-gray-100/50 p-8 md:p-10 rounded-[40px] border border-white shadow-lg backdrop-blur-sm">
                ...
                <div className="flex flex-col gap-4">
                  <a 
                    ...
                    className="w-full flex items-center justify-center gap-2 border-2 border-green-500 bg-transparent text-green-600 hover:bg-green-500 hover:text-white transition-all duration-300 transform active:scale-95 py-3.5 px-6 rounded-2xl font-bold"
                  >
                    Message WhatsApp
                  </a>
                  <a 
                    href="mailto:srilankaedentravels@gmail.com"
                    className="w-full flex items-center justify-center gap-2 btn-premium-primary py-3.5 px-6 rounded-2xl"
                  >
                    Envoyer un e-mail
                  </a>
                </div>
