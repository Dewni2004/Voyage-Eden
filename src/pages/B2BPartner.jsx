...
const localTranslations = {
  ...
  it: {
    ...
    driverEnglish: "Autista che parla inglese",
    driverSpanish: "Con autista-accompagnatore di lingua italiana (con supplemento)",
    guideSpanish: "Con guida ufficiale di lingua italiana (con supplemento)",
